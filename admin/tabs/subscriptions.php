...
$all_sub =$wpuserspro->membership->get_all_filtered();
           ...
           <table width="100%" class="">
            <thead>
                <tr>
                    ...
                    <th width="10%"><?php _e('Started', 'wp-users-pro'); ?></th> 
                    <th width="13%"><?php _e('Member', 'wp-users-pro'); ?></th> 
                     <th width="13%"><?php _e('Name', 'wp-users-pro'); ?></th>
                     <th width="10%"><?php _e('Valid From', 'wp-users-pro'); ?></th>
                    <th width="10%"><?php _e('Valid To', 'wp-users-pro'); ?></th> 
                     <th width="9%"><?php _e('Merchant ID', 'wp-users-pro'); ?></th>                  
                    ...
                    <td ><?php echo $subscription->subscription_id; ?></td> 
                     ...
                     <td><?php echo $date_created; ?>   </td> 
                      ...
                      <td><?php echo $date_to; ?> </td>   
                       <td ><?php echo $subscription->subscription_merchant_id; ?></td> 
